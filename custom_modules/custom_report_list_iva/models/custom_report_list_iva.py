                ...
                SELECT  max(x_account_line_id) id,
                    ...
                    FROM (
                        SELECT a_m.id as x_account_id,
                            ...
                            CASE WHEN a_m.amount_total_signed >= 0 THEN a_m_l.price_subtotal ELSE a_m_l.price_subtotal*-1 END as x_invoice_amount_untaxes,
                            ...
                            CASE WHEN a_m.amount_total_signed >= 0 THEN (a_m_l.price_subtotal * sum(a_t.amount) / 100) ELSE (a_m_l.price_subtotal * sum(a_t.amount) / 100)*-1 END  x_invoice_taxes_value,
                            CASE WHEN a_m.amount_total_signed >= 0 THEN a_m_l.price_total ELSE a_m_l.price_total*-1 END as x_invoice_amount_total
